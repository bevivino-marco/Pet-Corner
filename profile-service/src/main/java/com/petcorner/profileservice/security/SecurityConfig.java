...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.cors().disable()
                ...
                .and()
                .authorizeRequests().antMatchers("/profile/v2/login/**","/profile/v2/upload/files/**", "/profile/v2/token/refresh","/profile/v2/user/save/**","/profile/v2/animal/add-animal-adopt-queue").permitAll()
                .and()
